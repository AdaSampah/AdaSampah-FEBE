...
const missionItems = [
  {
    number: 1,
    text: "Mendorong masyarakat aktif melaporkan penemuan sampah liar dan pembuangan sembarangan demi lingkungan yang lebih bersih.",
  },
  {
    number: 2,
    text: "Memberikan edukasi dan solusi penanganan sampah melalui fitur 'Kenali Sampahmu' agar masyarakat lebih bijak dalam mengelola sampah.",
  },
  {
    number: 3,
    text: "Menghubungkan masyarakat dan pemerintah untuk bersama-sama mewujudkan pengelolaan sampah yang cerdas, kolaboratif, dan berkelanjutan.",
  },
];
...
export default function HomeMisiKami() {
  return (
    <section
      className="mt-20 w-full min-h-[520px] bg-cover bg-no-repeat bg-center relative overflow-hidden flex items-center justify-center"

...
const Card = ({ dataSampah, index }) => {
  return (
    <div
      key={index}
      className="cardKu shadow-[0px_2px_8px_0px_rgba(0,0,0,0.25)]  lg:max-w-[360px] max-w-[320px] rounded-3xl "
    >
      <div className="p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="lg:text-smallText text-[12px] text-[#5B5B5B] font-medium">
              {dataSampah.kabupaten}, {dataSampah.provinsi} ·{" "}
              {dataSampah.kategori}
            </p>
          </div>
          {/* <img src={titikTiga} alt="titikTiga" /> */}
        </div>
        <p className="lg:text-smallText text-[12px] text-[#222] font-medium overflow-hidden line-clamp-4 my-2">
          {dataSampah.deskripsi}
        </p>
        ...
        <div className="flex items-center justify-between mt-4">
          <div>
            <div className="flex gap-2 justify-center items-center px-2 py-2 border-[1px] border-[#D7D9DA] bg-[#F1F1F1] rounded-2xl font-semibold cursor-pointer">
              ...
              <span className="text-[#636466] text-[12px]">
                Upvote · {dataSampah.upvote.toLocaleString("id-ID")}
              </span>
            </div>
          </div>

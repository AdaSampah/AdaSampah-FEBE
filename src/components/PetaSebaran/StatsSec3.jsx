...
const StatsSec3 = () => {
  ...
  function findTopKabupatens(data) {
    ...
    const sortedKabupatens = Object.entries(kabupatenCounts).sort((a, b) => b[1] - a[1]);
  ...
  const chartData = topKabupatens.map(([kabupaten, jumlah]) => [kabupaten, jumlah]);
      ...
      <div className="md:px-32 sm:px-10 px-10 lg:py-40 md:py-15 sm:py-10 py-10">
        ...
        <div className="flex flex-wrap lg:gap-8 gap-4 justify-around items-center">
          ...
          <p className="2xl:text-[18px] text-normal font-medium 2xl:w-[400px] lg:w-[380px] sm:w-auto w-[330px]">
            Statistik menyatakan bahwa kabupaten dengan laporan aktivitas laporan sampah adalah{" "}
